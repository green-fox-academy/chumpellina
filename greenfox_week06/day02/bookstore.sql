...
select book_mast.book_name, author.aut_name, category.cate_descrip, publisher.pub_name, purchase.purch_price  from book_mast
...
left join purchase on book_mast.book_price = purchase.purch_price;
